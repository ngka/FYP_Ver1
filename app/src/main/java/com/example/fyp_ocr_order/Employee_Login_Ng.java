...
public class Employee_Login_Ng extends AppCompatActivity {
    TextView output;
    TextView btnteacher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        biometricPrompt = new BiometricPrompt(Employee_Login_Ng.this,
            ...
            public void onAuthenticationSucceeded(
                ...
                startActivity(new Intent(Employee_Login_Ng.this, EmployeePage_Ng.class));
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(emailTXT) && TextUtils.isEmpty(passwordTxT)) {
                    Toast.makeText(Employee_Login_Ng.this, "Please Enter Email Address and Password", Toast.LENGTH_SHORT).show();
                } else if(TextUtils.isEmpty(emailTXT)) {
                    Toast.makeText(Employee_Login_Ng.this, "Please Enter Email Address", Toast.LENGTH_SHORT).show();
                } else if(TextUtils.isEmpty(passwordTxT)) {
                    Toast.makeText(Employee_Login_Ng.this, "Please Enter the Password", Toast.LENGTH_SHORT).show();
        ...
        mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()) {
                    ...
                    try {
                        // 登入成功後跳轉到 OCR_Ng 介面
                        Intent intent = new Intent(Employee_Login_Ng.this, EmployeePage_Ng.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();
                    } catch (Exception e) {
                        e.printStackTrace();
                        Toast.makeText(Employee_Login_Ng.this, "Login Success", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Employee_Login_Ng.this, "Login failed!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
